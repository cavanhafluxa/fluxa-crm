...
import { Phone, Building2, DollarSign, ArrowUpRight, Calendar } from 'lucide-react'
import { Lead, STAGE_COLORS } from '@/lib/supabase'
...
export function PipelineCard({ lead, onClick, isDragOverlay, isFirst }: PipelineCardProps) {
  ...
  // First card gets the dark highlighted style (like Jane Doe in the reference)
